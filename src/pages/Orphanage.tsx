...
// utilizado para pegar os parâmetros passados pela url
...
interface RouteParams {
  id: string; //parâmetros da url são string
}
        ...
        <div className="orphanage-details">
          ...
          <div className="orphanage-details-content">
            ...
            <div className="map-container">
              ...
              <footer>
                {/* Link para gerar a rota (https://stackoverflow.com/questions/45116011/generate-a-google-map-link-with-directions-using-latitude-and-longitude) */}
